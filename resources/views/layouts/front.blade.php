...
<head>
    ...
    @endif
    <!-- Styles -->
    <link href="{{ asset('public/css/front/bootstrap.min.css') }}" type="text/css" rel="stylesheet">
    <link href="{{ asset('public/css/libs/fontawesome.min.css')}}" type="text/css" rel="stylesheet">
    <link href="{{ asset('public/css/front/owl.carousel.min.css')}}" type="text/css" rel="stylesheet">
    <link href="{{ asset('public/css/front/venor.css') }}" type="text/css" rel="stylesheet">
...
<body class="common-front @if($currentLang->rtl == 1) rtl @endif" @if($currentLang->rtl == 1) dir="rtl" @endif>
    ...
    <script src="{{ asset('public/js/front/bootstrap.min.js') }}" defer></script>
    <script src="{{ asset('public/js/front/owl.carousel.min.js') }}"></script>
    <script src="{{ asset('public/js/front/simpleParallax.min.js') }}" defer></script>
    <script src="{{ asset('public/js/front/countTO.js') }}" defer></script>
    <script src="{{ asset('public/js/front/typed.min.js') }}" defer></script>
    <script src="{{ asset('public/js/front/shuffleLetters.js') }} " defer></script>
    <script src="{{ asset('public/js/front/tilt.jquery.min.js') }} " defer></script>
    <script src="{{ asset('public/js/front/magnific.min.js') }}" defer></script>
    <script src="{{ asset('public/js/front/venor.js') }}" defer></script>
