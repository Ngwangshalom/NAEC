...
<head>
    ...
    <link href="{{asset('public/css/libs/custom-dashboard.css')}}" rel="stylesheet">
...
<body id="page-top">
    ...
    <script src="{{ asset('public/js/libs/dropzone.min.js') }}"></script>
    <script src="{{ asset('public/js/libs/custom-dashboard.js') }}"></script>
